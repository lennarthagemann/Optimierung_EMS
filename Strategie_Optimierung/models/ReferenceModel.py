...
"""
Dies ist das Referenzmodell für die stochastische Optimierung des EMS.
Die Szenariodaten und -struktur liegen im Ordner scenarios und werden durch die jeweiligen
...
-----------------------------------------------------------------------------------------------------
second stage:
-Basierend auf der Entscheidung erfüllt das EMS letztlich seine Verbrauchsdeckung usw.
im Rahmen seiner Möglichkeiten. Ist z.B. der Batteriebezug geblockt, so muss im schlechtesten
Fall Strom gekauft werden, obwohl Strom aus der Batterie verfügbar wäre. 
-----------------------------------------------------------------------------------------------------
"""
